...
```mermaid
quadrantChart
    title Trade Vulnerability Map
    x-axis Low Accessibility --> High Accessibility
    y-axis Low Protection --> High Protection
    quadrant-1 Protected but vulnerable
    quadrant-2 Institutionally defended
    quadrant-3 Low-access, low-scale
    quadrant-4 Open to substitution
    Licensed Electrician: [0.2, 0.82]
    Licensed Plumber: [0.35, 0.75]
    HVAC Technician: [0.55, 0.55]
    Auto Mechanic: [0.68, 0.25]
    Handyman: [0.85, 0.1]
```
